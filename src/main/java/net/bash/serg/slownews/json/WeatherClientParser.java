...
import net.bash.serg.slownews.pojo.Weather;
...
public class WeatherClientParser {
    ...
    private static final Logger LOGGER = Logger.getLogger(WeatherClientParser.class);
           ...
           try {
               ...
               while(!parser.isClosed()){
                   ...
                   if(JsonToken.FIELD_NAME.equals(jsonToken)){
                       ...
                       LOGGER.info(parser.getValueAsString());
